...
本文档记录项目维护的详细规则，包括**项目维护规范**和**文档写作指南**两大部分。

> **文档职责边界**：
> - **第一部分（一至二、九至十一章）**：项目维护规范 — 项目结构、文件归属、网盘筛选、测试闭环、状态查询
> - **第二部分（三至八、十二章）**：文档写作指南 — 文档组织、分解、分类、Docs as Code、定期梳理、AI友好写作、优化流程
> - **文档变更驱动流程（第十三章）**：两部分的联动机制 — 文档变化如何驱动目录结构和其他文档变化
