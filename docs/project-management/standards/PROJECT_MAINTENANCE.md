...
本文档记录项目维护的详细规则，包括**项目维护规范**、**文档写作指南**和**文档变更驱动流程**三大部分。

> **文档职责边界**：
> - **第一部分（一至五章）**：项目维护规范 — 项目结构、文件归属、网盘筛选、测试闭环、状态查询
> - **第二部分（六至十二章）**：文档写作指南 — 文档组织、分解、分类、Docs as Code、定期梳理、AI友好写作、优化流程
> - **第三部分（第十三章）**：文档变更驱动流程 — 两部分的联动机制，文档变化如何驱动目录结构和其他文档变化
...
| 文档 | 职责 | 联动触发时机 |
|------|------|-------------|
| **PROJECT_MAINTENANCE.md**（本文档） | 项目维护规范 + 文档写作指南 + 变更驱动流程 | 维护规则变更时 |
