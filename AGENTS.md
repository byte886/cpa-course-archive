...
| 角色 | 目录结构责任 | 文档编写责任 | 其他责任 |
|------|------------|------------|---------|
| **开发人员** | 实现目录结构、创建脚本目录、维护代码结构 | 技术文档、脚本说明、API文档、代码注释 | 功能开发、bug修复、性能优化、自动化流程 |
| **项目管理人员** | **设计目录结构**、规划文档体系、维护目录结构一致性 | **项目文档、流程文档、交接文档、ADR决策、规范文档** | 项目进度管理、风险管理、文档治理、流程优化 |
| **测试工程师** | 测试目录结构、测试数据目录 | 测试文档、测试用例、bug报告、测试报告 | 功能测试、回归测试、性能测试、验证修复 |
| **产品经理** | 产品功能目录、需求文档目录 | 需求文档、产品规划、用户反馈、产品路线图 | 需求分析、产品规划、用户研究、优先级排序 |

**核心原则**：
- **目录结构设计**：项目管理人员负责整体规划和设计，开发人员负责实现和维护
- **文档编写**：所有角色都有责任，但不同角色负责不同类型的文档（见上表）
- **文档是所有人的责任**：每个角色都要负责自己相关的文档，发现文档问题要及时修复
- **变更驱动更新**：目录结构或流程变化时，项目管理人员负责更新相关文档；功能变化时，开发人员负责更新技术文档
