...
5. **识别用户指定的角色**（开发人员/项目管理人员/测试工程师/产品经理），根据角色确定职责和关注点：
   - **开发人员**：关注技术实现、代码结构、待开发功能、技术问题
   - **项目管理人员**：关注项目进度、任务状态、风险问题、文档完整性、下一步计划
   - **测试工程师**：关注已测试功能、测试用例、已知bug、待测试功能、测试环境
   - **产品经理**：关注产品目标、已完成功能、待开发需求、用户反馈、产品规划
...
**用户启动新对话的最简方式**：
- 用户只需要把项目文件夹加入新对话
- 然后说角色名称即可（如"开发人员"、"项目管理人员"、"测试工程师"、"产品经理"）
